...
namespace Task4
{
    class Program
    {
        ...
        public static void Type1(int n)
        {
            ...
            Console.WriteLine("The result of the calculation according to the first formula: " + output);
        }
        ...
        public static void Type2(int n)
        {
            ...
            Console.WriteLine("The result of the calculation according to the second formula: " + output);
        }
        ...
        public static void Type3(int n)
        {
            ...
            Console.WriteLine("The result of the calculation according to the third formula: " + output);
        }
